...
st.title("PAINEL -  ASSOCIACÃO - ADESÕES - MÊS DEZEMBRO 2024")
...
escritorio = df.loc[df['Cooperativa'] =="PARANA"]['Parcela'].sum()
with col8:
     st.metric('Parcela Parana', round(escritorio, 2))
...
fig_tipo = px.bar(tipo, x= "Tipo", y= "Placa", barmode="group", text_auto=True, color= "Tipo", title= "Quantidade dos Tipos de Veículos")
